...
/*addEventListener("input", (event) => {
    const butt = document.getElementById("addStory");
    const input = document.getElementById("storia");

    console.log(input.value.length);

    if(input.value.length==0) butt.setAttribute("disabled", true);
    else butt.setAttribute("disabled", false);
});*/
